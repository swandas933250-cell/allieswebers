...
export function BackgroundPaths({
    ...
    return (
        <div id="hero-section" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-4 w-full px-4">
                        <div id="poda" className="relative flex items-center justify-center group">
                            ...
                            <Link to={buttonHref} className="relative z-10 block">
                                <Button
                                    ...
                                    hover:shadow-md dark:hover:shadow-neutral-800/50 min-w-[301px]"
                                >
                        ...
                        <div className="md:hidden">
                            <Link to="/templates">
                                <Button
                                    variant="outline"
                                    className="rounded-[1.15rem] px-8 py-4 text-sm font-semibold border-white/10 text-white/60 hover:text-white transition-all duration-300"
                                >
                                    Explore categories
                                </Button>
                            </Link>
